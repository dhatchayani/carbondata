...
public class BlockIndexerStorageForNoDictionary extends BlockIndexerStorage {
  ...
  @Override public byte[][] getDataPage() {
    return new byte[0][];
  }

  @Override public Object[] getDataPageForNoDictionary() {
    return dataPage;
  }
